...
YAHOO.widget.Column = function(oConfigs) {
    ...
    if(oConfigs && (oConfigs.constructor == Object)) {
   	...
   	// Section commented by Lucian, this is rather a backward incompatibiliy intervention
    // Backward compatibility
...
_initThEl : function(elTheadCell,oColumn,row,col, bA11y) {
    ...
    // Lucian addition : Set Column width
    if(oColumn.width) {
...
formatCell : function(elCell, oRecord, oColumn) {
    ...
    if(oRecord && oColumn) {
        ...
        // Lucian addition : Set Column width
         if (oColumn.width) {
        	elCell.parentNode.style.width = oColumn.width;
        }
